...
WEIGHTS = [
        ...
        '.build/weights.h5-1582193545',  # Feb 20 (02:12), 2020. Iter 15
        '.build/weights.h5-1582284936',  # Feb 21 (03:35), 2020. Iter 16
        '.build/weights.h5-1582381002',  # Feb 22 (06:16), 2020. Iter 17
        '.build/weights.h5-1582476075',  # Feb 23 (08:41), 2020. Iter 18
...
# Iter 13 vs 14
# Results for round 1: {'num_black_wins': 3, 'num_white_wins': 6, 'num_ties': 11}
# Results for round 2: {'num_black_wins': 3, 'num_white_wins': 1, 'num_ties': 16}
# Model 1 .build/weights.h5-1582007688 wins: 4
# Model 2 .build/weights.h5-1582100291 wins: 9

# Iter 14 vs 15
# Results for round 1: {'num_black_wins': 3, 'num_white_wins': 4, 'num_ties': 13}
# Results for round 2: {'num_black_wins': 2, 'num_white_wins': 1, 'num_ties': 17}
# Model 1 .build/weights.h5-1582100291 wins: 4
# Model 2 .build/weights.h5-1582193545 wins: 6

# Iter 15 vs 16
# Results for round 1: {'num_black_wins': 2, 'num_white_wins': 7, 'num_ties': 11}
# Results for round 2: {'num_black_wins': 3, 'num_white_wins': 4, 'num_ties': 13}
# Model 1 .build/weights.h5-1582193545 wins: 6
# Model 2 .build/weights.h5-1582284936 wins: 10

# Iter 16 vs 17
# Results for round 1: {'num_black_wins': 4, 'num_white_wins': 4, 'num_ties': 12}
# Results for round 2: {'num_black_wins': 10, 'num_white_wins': 2, 'num_ties': 8}
# Model 1 .build/weights.h5-1582284936 wins: 6
# Model 2 .build/weights.h5-1582381002 wins: 14

# Iter 17 vs 18
# Results for round 1: {'num_black_wins': 0, 'num_white_wins': 4, 'num_ties': 16}
# Results for round 2: {'num_black_wins': 7, 'num_white_wins': 0, 'num_ties': 13}
# Model 1 .build/weights.h5-1582381002 wins: 0
# Model 2 .build/weights.h5-1582476075 wins: 11

# Iter 18 vs 19
# Results for round 1: {'num_black_wins': 6, 'num_white_wins': 4, 'num_ties': 10}
# Results for round 2: {'num_black_wins': 5, 'num_white_wins': 3, 'num_ties': 12}
# Model 1 .build/weights.h5-1582476075 wins: 9
# Model 2 .build/weights.h5-1582572366 wins: 9

# Iter 19 vs 20
# Results for round 1: {'num_black_wins': 1, 'num_white_wins': 5, 'num_ties': 14}
# Results for round 2: {'num_black_wins': 5, 'num_white_wins': 1, 'num_ties': 14}
# Model 1 .build/weights.h5-1582572366 wins: 2
# Model 2 .build/weights.h5-1582675757 wins: 10

# Iter 20 vs 21
# Results for round 1: {'num_black_wins': 3, 'num_white_wins': 7, 'num_ties': 10}
# Results for round 2: {'num_black_wins': 8, 'num_white_wins': 2, 'num_ties': 10}
# Model 1 .build/weights.h5-1582675757 wins: 5
# Model 2 .build/weights.h5-1582779069 wins: 15
